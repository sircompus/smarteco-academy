$path0 = "C:\laragon\www\SEA\app\Http\Controllers\Student\CvController.php"
$content0 = @'
<?php
...
$path1 = "C:\laragon\www\SEA\resources\views\student\cv\_section-certifications.blade.php"
$content1 = @'
...
$path2 = "C:\laragon\www\SEA\resources\views\student\cv\_section-educations.blade.php"
$content2 = @'
...
$path3 = "C:\laragon\www\SEA\resources\views\student\cv\_section-experiences.blade.php"
$content3 = @'
...
$path4 = "C:\laragon\www\SEA\resources\views\student\cv\_section-languages.blade.php"
$content4 = @'
<section id="languages" class="mt-8 rounded-2xl bg-white p-6 shadow-sm">
    ...
    <form method="POST" action="{{ route('student.cv.languages.store') }}" class="mt-5 rounded-xl border border-dashed border-gray-300 p-4">
        @csrf
...
$path5 = "C:\laragon\www\SEA\resources\views\student\cv\_section-projects.blade.php"
$content5 = @'
