...
Set-Content -Path $packPath -Value $packContent -Encoding UTF8
Set-Content -Path $trainingPath -Value $trainingContent -Encoding UTF8

Write-Host "Fichiers ecrits avec succes." -ForegroundColor Green
Write-Host ""
Write-Host "Verification pack receipt:" -ForegroundColor Cyan
Select-String -Path $packPath -Pattern "148mm"
Write-Host ""
Write-Host "Verification training receipt:" -ForegroundColor Cyan
Select-String -Path $trainingPath -Pattern "148mm"
