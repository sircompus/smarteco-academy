$path0 = "C:\laragon\www\SEA\resources\views\admin\dashboard.blade.php"
$content0 = @'
...
try {
    ...
    Write-Host "OK: resources/views/admin/dashboard.blade.php" -ForegroundColor Green
} catch {
    Write-Host "ECHEC: resources/views/admin/dashboard.blade.php -- $($_.Exception.Message)" -ForegroundColor Red
}
