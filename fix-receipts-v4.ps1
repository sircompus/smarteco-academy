$packPath = "C:\laragon\www\SEA\resources\views\admin\centre\pack-enrollments\receipt.blade.php"
$trainingPath = "C:\laragon\www\SEA\resources\views\admin\trainings\enrollments\receipt.blade.php"
...
@section('content')
    ...
    <div class="receipt-a5 mx-auto flex flex-col rounded-2xl border border-gray-200 bg-white text-sm print:mx-0 print:rounded-none print:border-0 print:shadow-none">
        ...
        <div class="rounded-t-2xl bg-indigo-600 px-6 py-4 print:rounded-none">
            ...
            <h1 class="mt-2 text-center text-base font-extrabold uppercase tracking-[0.2em] text-white">
                Reçu de paiement
            </h1>
        </div>
        ...
        <div class="flex flex-1 flex-col px-6 py-4">
            ...
            {{-- Totaux --}}
            <div class="mt-4 space-y-1 rounded-xl bg-gray-50 px-4 py-3 text-right">
            ...
            {{-- Pied de page --}}
            <div class="mt-auto pt-4 text-center text-[10px] text-gray-400">
...
[System.IO.File]::WriteAllText($packPath, $packContent, [System.Text.UTF8Encoding]::new($false))
[System.IO.File]::WriteAllText($trainingPath, $trainingContent, [System.Text.UTF8Encoding]::new($false))

Write-Host "Fichiers ecrits avec succes (UTF-8)." -ForegroundColor Green
Select-String -Path $packPath -Pattern "margin: 7mm"
