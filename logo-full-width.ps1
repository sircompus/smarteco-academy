...
$path1 = "C:\laragon\www\SEA\resources\views\layouts\student.blade.php"
$content1 = @'
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body x-data="{ sidebarOpen: false }" class="min-h-screen bg-gray-100 text-gray-900">
    ...
    >
        <div class="flex flex-col items-center gap-2 border-b border-gray-200 px-6 py-5">
            <a href="{{ route('professor.dashboard') }}" class="flex flex-col items-center gap-2 text-center">
                <img src="{{ asset('images/smarteco-logo.png') }}" class="w-full h-auto object-contain" alt="SmartEco Academy">
...
$path3 = "C:\laragon\www\SEA\resources\views\layouts\supervisor.blade.php"
$content3 = @'
<!DOCTYPE html>
<html lang="fr">
<head>
...
$path4 = "C:\laragon\www\SEA\resources\views\layouts\guest.blade.php"
$content4 = @'
<!DOCTYPE html>
<html lang="fr">
    <head>
