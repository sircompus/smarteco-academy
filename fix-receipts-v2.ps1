...
Write-Host "Fichiers ecrits avec succes (UTF-8 sans BOM)." -ForegroundColor Green
Write-Host ""
Write-Host "Verification pack receipt:" -ForegroundColor Cyan
Select-String -Path $packPath -Pattern "148mm"
Write-Host ""
Write-Host "Verification accents (doit afficher 'Recu de paiement' correctement) :" -ForegroundColor Cyan
Select-String -Path $packPath -Pattern "REQU|Reçu de"
