$path0 = "C:\laragon\www\SEA\app\Models\PackEnrollment.php"
$content0 = @'
<?php
...
try {
    ...
    Write-Host "OK: app/Models/PackEnrollment.php" -ForegroundColor Green
} catch {
    Write-Host "ECHEC: app/Models/PackEnrollment.php -- $($_.Exception.Message)" -ForegroundColor Red
}

$path1 = "C:\laragon\www\SEA\resources\views\admin\centre\pack-enrollments\index.blade.php"
$content1 = @'
...
try {
    ...
    Write-Host "OK: resources/views/admin/centre/pack-enrollments/index.blade.php" -ForegroundColor Green
} catch {
    Write-Host "ECHEC: resources/views/admin/centre/pack-enrollments/index.blade.php -- $($_.Exception.Message)" -ForegroundColor Red
}
